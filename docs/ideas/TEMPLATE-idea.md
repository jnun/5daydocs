<!--
SYNC NOTE: This template is for human reference. The actual idea generator
is docs/5day/scripts/create-idea.sh. Keep both in sync manually when making format changes.
-->
