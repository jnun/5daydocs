...
#   2. If done → marks ## Completed, script moves to review/
#   3. If blocked → writes ## Blocked Analysis, script moves to blocked/
#   4. If workable → implements, marks ## Completed, script moves to review/
#
# Usage:
