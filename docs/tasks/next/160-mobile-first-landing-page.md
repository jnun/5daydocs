# Task 160: mobile first landing page
...
As a visitor on a mobile device, the signup is under the HERO and I have to scroll to sign up. Sign up should be front and center, simplest, fastest.
