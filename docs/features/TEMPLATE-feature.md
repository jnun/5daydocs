<!--
SYNC NOTE: This template is for human reference. The actual feature generator
is docs/5day/scripts/create-feature.sh. Keep both in sync manually when making format changes.
-->
